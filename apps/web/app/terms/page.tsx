    ...
    <main className="landing">
      <RailsLayout>
        ...
        >
          ...
          <p>
            You are responsible for your account, connected services,
            instructions, approval settings, and the legality of the data and
            access you provide. You must review agent output before relying on
            it where errors could cause harm.
          </p>
          <h2>4. Billing</h2>
          <p>
            Paid plans renew automatically for the selected billing period until
            cancelled. Prices, trial terms, taxes, and renewal details are shown
            at checkout. Except where required by law, charges already paid are
            non-refundable.
          </p>
          ...
          <p>
            Models, integrations, hosting providers, and other third-party
            services have their own terms. We are not responsible for changes,
          ...
          <p>
            These terms are governed by the laws of Australia. Mandatory
            consumer rights that cannot legally be excluded continue to apply.
          </p>
          <h2>12. Contact</h2>
          <p>
