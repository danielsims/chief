/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: df40850fd95c1c1ccb735b3da7e1755c)
// Runtime types generated with workerd@1.20260811.1 2026-08-17 nodejs_compat
interface __BaseEnv_Env {
	ARTIFACTS: R2Bucket;
	AUTH_DB: D1Database;
	EDGE_REQUEST_RATE_LIMITER: RateLimit;
	IDENTITY_REQUEST_RATE_LIMITER: RateLimit;
	...
	RELAY_TELEMETRY_MODE: string;
	RELAY_TELEMETRY_INCLUDE_CONTENT: string;
	...
	CONVERSATIONS: DurableObjectNamespace<import("./src/index").ConversationObject>;
	AGENTS: DurableObjectNamespace<import("./src/index").AgentObject>;
	METRICS: DurableObjectNamespace<import("./src/index").AnalyticsObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WorkspaceObject" | "ConversationObject" | "AgentObject" | "AccountObject" | "AnalyticsObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RELAY_ID" | "RELAY_DEPLOYMENT" | "RELAY_TELEMETRY_MODE" | "RELAY_TELEMETRY_INCLUDE_CONTENT" | "HOSTED_CELL_ENABLED" | "HOSTED_AGENT_COMPACTION_RATIO" | "ACCOUNT_IDENTITY_MODE" | "AUTH_BASE_URL" | "AUTH_UI_ORIGIN" | "AUTH_GOOGLE_REDIRECT_URI">> {}
}
