...
import { n as require_token_util, r as require_token_error } from "./@vercel/connect+[...].mjs";
import { a as require_token_util$1, o as require_token_error$1 } from "./@ai-sdk/gateway+[...].mjs";
import { t as require_dist } from "./@vercel/cli-config+[...].mjs";
...
var require_token = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	__export(token_exports, { refreshToken: () => refreshToken });
	module.exports = __toCommonJS(token_exports);
	var import_cli_config = require_dist();
...
//#endregion
export { require_token$1 as n, require_token as t };
